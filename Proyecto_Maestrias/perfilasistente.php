                            ...
                            <form class="row g-3" name="modificar asistente" method="POST" action="php/ModificarAsistente.php">
                              <table class="table table-success table-striped">
                                ...
                                <td>
                                  ...
                                  <td >
                                    <input type="date" name="fechanavinculacion" placeholder="FechaVinculacion" class="form-control" id="validationDefault09" value="<?php echo $fechavinculacion; ?>" required>
                                  </td>
                                  <td>
                                    Contraseña:
                                  </td>
                                ...
                                while($mostrar_maestrias=mysqli_fetch_array($consulta_maestrias))
                                {
                                  ...
                                  ?>
                                    <tr align="center">
                                      ...
                                      <td>
                                        <?php echo "<a href='perfilasistente.php? id=".$mostrar_maestrias['CodSNIES']."'>Aceptar</a>" ?>
                                      </td>
                                    </tr>
                                    <?php
                                  }
