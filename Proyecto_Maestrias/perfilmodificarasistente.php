  ...
  <div class="row h-100 justify-content-center align-items-center">
    <div class="card col-10 " style="background-color: #F0F2EE;">
      <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example bg-transparent p-3 rounded-2" tabindex="0">
       ...
       $consultaa = "SELECT Cedula, CodSNIES, FechaVinculacion FROM asistente WHERE Cedula = '$consultaa' ";
       ...
       $con2 = "SELECT Cedula FROM asistente WHERE Cedula = '$_POST[cedula]' ";
       $con2 = mysqli_query($conexion,$con2);
       $con2 = mysqli_fetch_array($con2);

       if ($con2) {
         $codsnies = "SELECT CodSNIES FROM coordinador WHERE Cedula = '$_SESSION[cedula]' ";
         $codsnies = mysqli_query($conexion,$codsnies);
         $codsnies = mysqli_fetch_array($codsnies);

         $conxx = "SELECT CodSNIES FROM asistente WHERE Cedula = '$_POST[cedula]' ";
         $conxx = mysqli_query($conexion,$conxx);
         $conxx = mysqli_fetch_array($conxx);
         if($codsnies != $conxx){
          $consultaww = "SELECT Cedula FROM presidente WHERE Cedula = '$_SESSION[cedula]' ";
          $consultaww = mysqli_query($conexion, $consultaww);
          $consultaww = mysqli_fetch_array($consultaww);

          $consulta1ww = "SELECT Cedula FROM coordinador WHERE Cedula = '$_SESSION[cedula]' ";
          $consulta1ww = mysqli_query($conexion, $consulta1ww);
          $consulta1ww = mysqli_fetch_array($consulta1ww);
          if($consultaww){
            ?>
        ...
        ?>
        <form class="row g-3" name="modificar asistente" method="POST" action="php/ModificarAsistentePres.php">
          <table class="table table-success table-striped">
            <tr align="center" valign="middle">
              <td>
                Cedula:
