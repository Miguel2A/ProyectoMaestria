        ...
        <form class="row g-3" name="modificar cohorte" method="POST" action="php/ModificarCohorte.php">
          <table class="table table-success table-striped">
            <tr align="center" valign="middle">
              ...
              <td>
                <input type="int" name="codigosnies" placeholder="CodSNIES" class="form-control" value="<?php echo $codigosnies ?>" id="validationDefault01"  required >
              </td>
              <td>
                Nombre:
              </td>
            ...
            <tr align="center" valign="middle">
              ...
              <td>
                <input type="int" name="numeroestudiantes" placeholder="NumeroEstudiantes" class="form-control" value="<?php echo $numeroestudiantes ?>" id="validationDefault05"  required>
              </td>
            </tr>
