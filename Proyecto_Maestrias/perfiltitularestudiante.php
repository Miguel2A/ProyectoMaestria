          ...
          <table class="table table-success table-striped">
            <tr align="center" valign="middle">
              <td>
                              ...
                              <td>
                                <input type="number" name="codigosnies" placeholder="CodSNIES" class="form-control" value="<?php echo $codigosnies ?>" id="validationDefault01" required>
                              </td>
                            ...
                            <tr align="center" valign="middle">
                              ...
                              <td>
                                <input type="number" name="semestre" placeholder="Semestre" class="form-control" value="<?php echo $semestre ?>" id="validationDefault01" required>
                              </td>
                              <td>
                                Fecha de Ingreso:
                              </td>
