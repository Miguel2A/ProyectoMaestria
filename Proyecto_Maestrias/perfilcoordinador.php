                                ...
                                while($mostrar_maestrias=mysqli_fetch_array($consulta_maestrias))
                                {
                                  ...
                                  ?>
                                    <tr align="center">
                                      ...
                                      <td>
                                        <?php echo "<a href='perfilcoordinador.php? id=".$mostrar_maestrias['CodSNIES']."'>Aceptar</a>" ?>
                                      </td>
                                    </tr>
                                    <?php
                                  }
                                  //con .$_GET['CodSNIES']. recibo la variable a la pagina a enviar 
                                }
                                ?>
                              </table>
                            </div>
                        ...
                        <table class="table table-success table-striped">
                          ...
                          <tr align="center" valign="middle">
                            ...
                            <td>
                              ...
                              /*$consulta_codigosniescoor = "SELECT CodSNIES FROM programa WHERE CodSNIES = $_SESSION['codigosnies'] ";
                              $consulta_codigosniescoor = mysqli_query($conexion, $consulta_codigosniescoor);
                              $consulta_codigosniescoor = mysqli_fetch_array($consulta_codigosniescoor);*/

                              $consulta_codigosnies = "SELECT CodSNIES FROM programa ";
                              $consulta_codigosnies = mysqli_query($conexion, $consulta_codigosnies);
                              //$consulta_codigosnies = mysqli_fetch_array($consulta_codigosnies);
                              ...
                              while($mostrar_codigosnies=mysqli_fetch_array($consulta_codigosnies))
                                {
                                  ...
                                  //con .$_GET['CodSNIES']. recibo la variable a la pagina a enviar ?nombre=Hannes 
                                }
                                ?>
