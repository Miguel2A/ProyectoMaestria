                            ...
                            <form class="row g-3" name="modificar presidente" method="POST" action="php/ModificarPresidente.php">
                              <table class="table table-success table-striped">
                                ...
                                <tr align="center" valign="middle">
                                  ...
                                  <td>
                                    <input type="text" name="genero" placeholder="Genero" class="form-control" id="validationDefault08" value="<?php echo $genero; ?>" required>
                                  </td>
                                  <td>
                                    Fecha de Nacimiento:
                                  </td>
                          ...
                          <table class="table table-striped" align="center">
                            <td align="center">
                              <div class="col-md-6">
                                ...
                                <input type="text" name="codigosnies" placeholder="Ingrese codigo SNIES" class="form-control" id="coddd" required>
                                <br>
                              ...
                              <form class="row g-3" name="nuevo programa" method="POST" action="php/CrearPrograma.php">
                                <table class="table table-success table-striped">
                                  ...
                                  <tr align="center" valign="middle">
                                    ...
                                    <td >
                                      <input type="file" name="logo" placeholder="Logo" class="form-control" id="validationDefault05" required>
                                    </td>
                                    <td>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingCuatro">
                    <button class="accordion-button collapsed bg-secondary text-white" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseCuatro" aria-expanded="false" aria-controls="flush-collapseCuatro">
                      Coordinadores de las Maestrias.
                    </button>
                  </h2>
