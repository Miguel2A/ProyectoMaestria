        ...
        <form class="row g-3" name="modificar maestria" method="POST" action="php/ModificarMaestria.php">
          <table class="table table-success table-striped">
            ...
            <tr align="center" valign="middle">
              ...
              <td>
                <input type="text" name="logo" placeholder="Logo" class="form-control" value="<?php echo $logo ?>" id="validationDefault05"  required>
              </td>
              <td>
                Correo:
              </td>
              ...
              <td>
                <input type="text" name="lineatrabajo" placeholder="LineaTrabajo" class="form-control" value="<?php echo $lineatrabajo ?>" id="validationDefault05"  required>
              </td>
            </tr>
            <tr align="center" valign="middle">
              <td>
              ...
              <td colspan="2">
                <input type="int" name="numeroresolucion" placeholder="NumeroResolucion" class="form-control" value="<?php echo $numeroresolucion ?>" id="validationDefault05"  required>
              </td>
            </tr>
            <tr align="center" valign="middle">
              <td>
